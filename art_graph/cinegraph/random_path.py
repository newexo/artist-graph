...
from .node_types import ProfessionalNode, PersonNode
...
def make_path_from_starting_node(
...
def make_path_by_iteration(
    ...
    for _ in range(max_iter):
        try:
            return make_path_from_starting_node(
...
class PathMaker:
    ...
    def make_game(
        ...
        return make_path_by_iteration(self.g, self.candidates, distance, r=r)
